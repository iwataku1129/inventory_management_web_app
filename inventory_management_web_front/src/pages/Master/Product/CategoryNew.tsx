...
export const CategoryNew = (props: { index: string }) => {
    ...
    if (props.index === "kamoku_cat") {
        indexLabel = { title: "科目カテゴリ", field: "product_kamoku_category", api: apiPath.master.productKamokuCat || "" }
    } else if (props.index === "cat1") {
        indexLabel = { title: "製品カテゴリ1", field: "product_category_1", api: apiPath.master.productCat1 || "" }
    } else if (props.index === "cat2") {
        indexLabel = { title: "製品カテゴリ2", field: "product_category_2", api: apiPath.master.productCat2 || "" }
    } else if (props.index === "cat3") {
        indexLabel = { title: "製品カテゴリ3", field: "product_category_3", api: apiPath.master.productCat3 || "" }
    } else {
        return (<></>)
    }
