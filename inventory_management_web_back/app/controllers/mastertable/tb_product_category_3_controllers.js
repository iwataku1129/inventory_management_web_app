...
const tb_product_category_3 = db.tb_product_category_3;
...
// Create and Save a new tb_product_category_3
exports.create = async (req, res) => {
    ...
    try {
        ...
        // Validate request
        if (!req.headers.invcat || !req.body.product_category_3) {
            await tx.rollback();
        ...
        // 重複チェック
        const conflict_check = await tb_product_category_3.findOne({ where: { [Op.and]: { inventory_category_id: inventory_category_id, product_category_3: req.body.product_category_3, del_flg: 0 } } })
        if (conflict_check) {
            await tx.rollback();
        ...
        // Set create data
        const tb_product_category_3_create = {
            inventory_category_id: inventory_category_id,
            product_category_3: req.body.product_category_3,
            del_flg: 0,
        ...
        // Save database
        const ret = await tb_product_category_3.create(tb_product_category_3_create, { transaction: tx })
...
// Update a tb_product_category_3 by the id in the request
exports.update = async (req, res) => {
    ...
    try {
        ...
        // 登録実績・同期チェック
        const conflict_check = await tb_product_category_3.findOne({ where: { [Op.and]: { id: req.body.id, inventory_category_id: inventory_category_id, product_category_3: req.body.product_category_3, del_flg: 0 } }, order: [["updated_at", "desc"]] })
        if (!conflict_check) {
            await tx.rollback();
        ...
        const ret_update = await tb_product_category_3.update({
            //inventory_category_id: inventory_category_id,
            product_category_3: req.body.product_category_3,
            del_flg: 0,
            updated_by: userinfo.id,
...
// Delete a tb_product_category_3 by the id in the request
exports.delete = async (req, res) => {
    ...
    try {
        ...
        // 登録実績チェック
        const conflict_check = await tb_product_category_3.findOne({ where: { [Op.and]: { id: req.params.id, inventory_category_id: inventory_category_id, del_flg: 0 } }, order: [["updated_at", "desc"]] })
        if (!conflict_check) {
            await tx.rollback();
            res.status(400).send({ message: "No registration" })
            return;
...
// Find a single tb_product_category_3 with an id
exports.findOne = async (req, res) => {
    try {
        ...
        // Get datas
        const get_data_one = await tb_product_category_3.findOne({ where: { [Op.and]: { id: req.params.id, inventory_category_id: inventory_category_id, del_flg: 0 } } })
        if (get_data_one) {
...
// Retrieve all tb_product_category_3s from the database.
exports.findAll = async (req, res) => {
    try {
        ...
        // Get datas
        const get_data_all = await db.tb_product_category_3.findAll({ where: { inventory_category_id: inventory_category_id, del_flg: 0 }, order: [["id", "asc"]] })
