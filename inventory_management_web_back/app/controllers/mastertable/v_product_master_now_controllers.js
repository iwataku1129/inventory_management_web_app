...
const v_product_master_now = db.v_product_master_now;
...
// Find a single v_product_master_now with an id
exports.findOne = async (req, res) => {
    try {
        ...
        // Get datas
        const get_data_one = await v_product_master_now.findOne({ where: { [Op.and]: { product_code: req.params.product_code, inventory_category_path: req.headers.invcat, del_flg: 0 } } })
...
// Retrieve all v_product_master_nows from the database.
exports.findAll = async (req, res) => {
    try {
        ...
        // Get datas
        const get_data_all = await db.v_product_master_now.findAll({ where: { inventory_category_path: req.headers.invcat, del_flg: 0 }, order: [["id", "asc"]] })
