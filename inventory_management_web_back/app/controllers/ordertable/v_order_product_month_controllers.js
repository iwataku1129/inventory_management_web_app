...
const v_order_product_month = db.v_order_product_month;
...
// Find a single v_order_product_month with an id
exports.findOne = async (req, res) => {
    try {
        ...
        // Get datas
        const get_data_one = await v_order_product_month.findOne({ where: { [Op.and]: { id: req.params.id, inventory_category_path: req.headers.invcat } } })
        if (get_data_one) {
...
// Retrieve all v_order_product_months from the database.
exports.findAll = async (req, res) => {
    try {
        ...
        const get_data_all = await v_order_product_month.findAll({ where: { [Op.and]: query }, order: [["product_code", "asc"]], limit: 10000 })
